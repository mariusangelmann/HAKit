...
## [0.4.10] - 2026-02-02
- Added: Public `engine` parameter in `HAConnectionInfo` to support custom WebSocket engines.
- Added: `HAClientCertificateEngine` for mTLS client certificate authentication.
